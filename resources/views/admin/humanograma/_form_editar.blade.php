...
<div class="tab-content" id="myTabContent">
	<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
		...
		<div class="form-group">
			...
			<select class="form-control" name="fbb_conselheiro_id" value="{{isset($registro->fbb_conselheiro_id) ? $registro->fbb_conselheiro_id : ''}}">
				@foreach($fbb_conselheiros as $fc)
					<option value="{{$fc->id}}" @if ($fc->id === $registro->fbb_conselheiro_id)	selected @endif">{{$fc->nome}}
		...
		<div class="form-group">
			...
			@if ($registro->comite_investimento ===	 "sim"){
		...
		<div class="form-group">
			...
			<input type="file" class="form-control-file" name="foto" value="{{isset($registro->foto) ? $registro->foto : ''}}" required>
		</div>
	...
	<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
		...
		<div class="form-group">
			<label for="TelefoneSecretaria">Telefone Fixo</label>
	...
	<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
		...
		<div class="form-group">
			...
			<textarea class="form-control" name="desccurriculo" type="text" placeholder="Digite a descrição">{{isset($registro->desccurriculo) ? $registro->desccurriculo : ''}}</textarea>
	...
	<div class="tab-pane fade" id="endereco" role="tabpanel" aria-labelledby="endereco-tab">
		...
		<div class="form-group">
			<label for="cargo">Telefone Fixo</label>
